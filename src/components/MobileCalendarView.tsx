                ...
                return (
                  ...
                  >
                    ...
                    {hasPartialAvailability && isCurrentMonth && (
                      <span className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-[9px] font-semibold bg-green-500 text-white px-1.5 py-0.5 rounded-full z-10">
                        {availableRooms} left
                      </span>
                    )}
